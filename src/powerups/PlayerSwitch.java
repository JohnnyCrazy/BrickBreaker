...
public class PlayerSwitch extends Powerup
{
	...
	public void drop(Ingame ing) {
		...
		image_big = null;
		try {
			image_big = new Image("./resources/powerup_player_wechsel.png");
	...
	public void onActivate() 
	{
		...
		watch.setTime(time);
		watch.start();
		ing.getPlayer().setSwitched(true);
	}
	@Override
	public void onDeactivate() 
	{
		ing.getPlayer().setSwitched(false);
	}
	@Override
